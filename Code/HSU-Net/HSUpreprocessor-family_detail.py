...
def split_dataset():
    ...
    if os.path.exists(os.path.join(root_path,"train.txt")):
        os.remove(os.path.join(root_path,"train.txt"))
    if os.path.exists(os.path.join(root_path,"test.txt")):
        os.remove(os.path.join(root_path,"test.txt"))
    if os.path.exists(os.path.join(root_path,"valid.txt")):
        os.remove(os.path.join(root_path,"valid.txt"))
    ...
    for label in label_list:
        ...
        if label == 'Benign':
            ...
            mini_label_list = os.listdir(mini_path)
            for mini_lable in mini_label_list[:int(len(mini_label_list)*0.8)]:
                label_data_list = []
                data_list = glob.glob(os.path.join(mini_path,mini_lable,"*.npy"))
                for data_path in data_list:
                    data_path2 = (os.path.join(root2_path,label,mini_lable,data_path.split('/')[-1]))
